...
<head>
  ...
  <title>Pull Out Remarks | Paragon</title>
...
<body>
  ...
  <aside class="sidebar">
    ...
    <main class="main-content">
      <header class="header">
        <h1>Pull Out Remarks Management</h1>
        <div class="user-info">
      ...
      <section class="content">
        <div class="card">
          ...
          <div class="search-bar">
            ...
            <input type="text" id="searchInput" placeholder="Search remarks..." onkeyup="performSearch()">
          </div>
  ...
  <script>
    ...
    async function loadData() {
      try {
        const response = await fetch('../api/fetch-pull-out-remarks.php');
    ...
    async function submitAdd(event) {
      ...
      try {
        const response = await fetch('../api/add-pull-out-remarks.php', {
          method: 'POST',
          body: formData
        });
        const result = await response.json();
        ...
        if (result.success) {
          alert('Pull out remark added successfully!');
          closeAddModal();
          loadData();
        } else {
        ...
        alert('Error adding pull out remark');
      }
    }
    ...
    async function deleteItem(id) {
      ...
      try {
        ...
        const response = await fetch('../api/delete-pull-out-remarks.php', {
          method: 'POST',
          body: formData
        });
        const result = await response.json();
        ...
        if (result.success) {
          alert('Pull out remark deleted successfully!');
          loadData();
        } else {
          alert('Error: ' + result.message);
        }
      } catch (error) {
        alert('Error deleting pull out remark');
      }
    }
